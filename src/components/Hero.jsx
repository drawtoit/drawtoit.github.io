  ...
  return (
    <section id="top" className="relative flex min-h-screen items-center overflow-hidden">
      ...
      >
        ...
        />
        <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-void/85 to-transparent lg:hidden" />
        <div className="absolute inset-0 hidden lg:block lg:bg-gradient-to-r lg:from-void/70 lg:via-transparent lg:to-transparent" />
        <div className="absolute inset-x-0 bottom-0 hidden h-16 bg-gradient-to-t from-void/50 to-transparent lg:block" />
      </motion.div>
